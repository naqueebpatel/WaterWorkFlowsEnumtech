...
const PDFFile = () => {
    const pageColors = [ '#ffffff', '#ffffff', '#ffffff' ];

    const pages = [
        { text: 'First page content goes here...', image: "https://www.lamborghini.com/sites/it-en/files/DAM/lamborghini/news/2019/08_08_veneno/COVER_VENENO.jpg" },
